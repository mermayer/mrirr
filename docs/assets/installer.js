const translations = {
    de: {
        ...
        factory_warning_title: 'Keine normale Aktualisierung', factory_warning_text: 'Eine Factory-Installation kann alle WLAN-, Roon-, Slot- und IR-Einstellungen loeschen. Vorher ein Konfigurationsbackup exportieren. Fuer ein bestehendes MRIRR die Update-Alternativen unterhalb verwenden.',
        update_alternatives_title: 'Bestehendes MRIRR aktualisieren', update_alternatives_intro: 'Diese Wege erhalten die gespeicherte Konfiguration und sind fuer normale Firmwareupdates vorgesehen.',
        ...
        local_ota_title: 'Lokaler OTA-Upload', local_ota_text: 'Auf derselben Firmwareseite eine passende mrirr-ota-Datei auswaehlen. Niemals das Factory-Image in den OTA-Upload laden.', open_downloads: 'Zu den Firmwaredateien',
    ...
    en: {
        ...
        factory_warning_title: 'Not a normal update', factory_warning_text: 'A factory installation can erase all Wi-Fi, Roon, slot and IR settings. Export a configuration backup first. Use one of the update alternatives below for an existing MRIRR.',
        update_alternatives_title: 'Update an existing MRIRR', update_alternatives_intro: 'These methods retain the saved configuration and are intended for normal firmware updates.',
        ...
        local_ota_title: 'Local OTA upload', local_ota_text: 'Select a matching mrirr-ota file on the same firmware page. Never upload the Factory image through OTA.', open_downloads: 'Open firmware files',
